                            ...
                            <table class="table table-hover table-striped">
                                ...
                                <?php foreach($_SESSION['cart'] as $id => $item): ?>
                                    <tr>
                                        ...
                                        <td><?=$item['qty'] ?></td>
                                        <td><?=$item['price'] ?></td>
                                        <td><a href="/cart/delete/?id=<?=$id ?>"><span data-id="<?=$id ?>" class="glyphicon glyphicon-remove text-danger del-item" aria-hidden="true"><bold>&times;</bold></span></a></td>
                                    </tr>
                                <?php endforeach;?>
                                <tr>
                                    <td>Total:</td>
                            ...
                            <form method="post" action="cart/checkout" role="form" data-toggle="validator">
                                <?php if(!isset($_SESSION['user'])): ?>
                                    ...
                                    <div class="form-group has-feedback">
                                        ...
                                        <input type="password" name="password" class="form-control" id="password" placeholder="Password" value="<?= isset($_SESSION['form_data']['password']) ? $_SESSION['form_data']['password'] : '' ?>" data-minlength="4" data-error="Password must have at least 4 chars" required>
                                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
