...
<div class="single contact">
    ...
    data-base="<?=round($product->price * $curr['value']);?>">
                                <?=$curr['symbol_left'];?>
                                <?=round($product->price * $curr['value']);?>
                            <?=$curr['symbol_right'];?></h5>
                            <?php if($product->old_price): ?>
                                <del><?=$curr['symbol_left'];?><?=round($product->old_price * $curr['value']);?>
...
<?=round($item['price'] * $curr['value']);?>
<?=$curr['symbol_right'];?></span>
            <?php if($item['old_price']): ?>
            <del><?=$curr['symbol_left'];?><?=round($item['old_price'] * $curr['value']);?>
            <?=$curr['symbol_right'];?></del>
            <?php endif;?></h4>
                                </div>
                                <div class="srch">
